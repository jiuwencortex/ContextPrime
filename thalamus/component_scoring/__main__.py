# Enables: python -m thalamus.component_scoring [build] --type skills|memory|tools
#
# Examples:
#   python -m thalamus.component_scoring build --type skills \
