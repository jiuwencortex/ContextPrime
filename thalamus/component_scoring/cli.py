...
# Supports: python -m thalamus.component_scoring build --type skills|memory|tools
...
from thalamus.component_scoring.cli_args_parser import make_parser
from thalamus.component_scoring.cli_builders import build_skills, build_memory, build_tools
