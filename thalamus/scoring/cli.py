...
# Supports: python -m thalamus.scoring build --type skills|memory|tools
...
from thalamus.scoring.cli_args_parser import make_parser
from thalamus.scoring.cli_builders import build_skills, build_memory, build_tools
